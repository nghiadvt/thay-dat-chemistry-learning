<header class="kbe-header" id="kbeHeader">
  ...
  <div class="kbe-header-center">
    ...
    <div class="kbe-zoom-toggle" role="group" aria-label="Thu phóng">
      <button type="button" class="kbe-zoom-btn" data-zoom="0.5">50%</button>
      <button type="button" class="kbe-zoom-btn" data-zoom="0.75">75%</button>
      <button type="button" class="kbe-zoom-btn active" data-zoom="1">100%</button>
      <button type="button" class="kbe-zoom-btn" data-zoom="1.5">150%</button>
    </div>
  </div>
